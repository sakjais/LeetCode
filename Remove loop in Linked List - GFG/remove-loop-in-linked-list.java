...
class Solution {
    ...
    public static void removeLoop(Node head) {
        ...
        // If there is no loop, return immediately.
        if (slow != fast) {
            return;
        }
        ...
        // Find the node just before the loop to break the loop.
        while (fast.next != slow) {
            fast = fast.next;
        }

        // Break the loop by setting the next of the last node in the loop to null.
        fast.next = null;
    }
}
